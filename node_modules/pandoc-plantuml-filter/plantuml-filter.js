...
function filterPlantuml(type, value, format, meta) {
    ...
    var configPath = path.join(__dirname, "plantuml.config");
    var res = execSync(util.format("java -splash:no -jar \"%s\" -charset UTF-8 -pipe -Tsvg -config  \"%s\"", plantumlPath, configPath), { input: umlText });
